...
/**
 * Test the instagram120 RapidAPI endpoint with active subscription
 * @param {string} url - Instagram post/reel URL
 */
async function testInstagram120(url) {
...
if (require.main === module) {
  ...
  if (!url) {
    ...
    console.error('Example: node test-instagram120.js --url "https://www.instagram.com/p/XXXX/"');
    console.error('   or: node test-instagram120.js "https://www.instagram.com/p/XXXX/"');
    process.exit(1);
  }
  
  testInstagram120(url);
} 